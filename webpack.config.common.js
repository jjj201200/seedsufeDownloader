...
if (process.env.npm_config_setversion) {
    ...
    manifestJSON['update_url'] = process.env.npm_config_b360 ? 'http://upext.chrome.360.cn/intf.php?method=ExtUpdate.query' : 'https://clients2.google.com/service/update2/crx';
}
...
module.exports = {
    ...
    plugins: [
        new webpack.EnvironmentPlugin({
            ...require('./env'),
            runtimeVersion: manifestJSON.version,
            b360: process.env.npm_config_b360 || false,
        }),
